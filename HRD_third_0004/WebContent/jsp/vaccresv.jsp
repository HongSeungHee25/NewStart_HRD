...
%>
	...
	<form action="vaccresvAction.jsp" method="post">
		<table>
			<tr>
				<th>예약번호</th>
				<td><input type="text" name="resvno" id="resvno" value="<%= resvno %>" readonly="readonly"></td>
			</tr>
			<tr>
				<th>주민번호</th>
			...
			<tr>
				<th>예약날짜</th>
				<td><input type="text" name="resvdate" id="resvdate"></td>
			</tr>
			<tr>
				<th>예약시간</th>
				<td><input type="text" name="resvtime" id="resvtime"></td>
			</tr>
			<tr>
				<th colspan="2">
