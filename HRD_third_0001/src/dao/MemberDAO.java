...
public class MemberDAO {
	...
	public List<MemberDTO> getLangKing() throws SQLException{
		Connection conn = OracleUtil.getConnection();
		String sql = "select a.m_no, b.m_name, count(*) as rang\r\n"
				+ "from TBL_VOTE_202005 a join TBL_MEMBER_202005 b\r\n"
				+ "on a.m_no = b.m_no\r\n"
				+ "where a.v_confirm = 'Y'\r\n"
		...
		List<MemberDTO> list = new ArrayList<MemberDTO>();
		while(rs.next()) {
			MemberDTO dto = new MemberDTO(rs.getString(1), rs.getString(2), rs.getInt(3));
			list.add(dto);
		}
		rs.close();
		ps.close();
