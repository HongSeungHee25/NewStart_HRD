	...
	<table>
		...
		<% 
			...
			for(int i=0;i<list.size();i++){
				String schoolNo = list.get(i).getP_school();
				String p_school = "";
				if(schoolNo.equals("1")) p_school="고졸";
				else if(schoolNo.equals("2")) p_school="학사";
				else if(schoolNo.equals("3")) p_school="석사";
				else if(schoolNo.equals("4")) p_school="박사";
		%>
		<tr>
